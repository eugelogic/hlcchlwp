			...
			<section class="error-404 not-found">
				...
				<div class="page-content">
					...
					<div class="widget widget_categories">
						<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'hlcchl' ); ?></h2>
						<ul>
						<?php
					...
					<?php
						...
						$archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'hlcchl' ), convert_smilies( ':)' ) ) . '</p>';
